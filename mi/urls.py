...
urlpatterns = [
    ...
    url(r"^sector_teams/overview/$", SectorTeamsOverviewView.as_view(),
        name="sector_teams_overview"),
    url(r"^sector_teams/(?P<team_id>\d+)/$",
        SectorTeamDetailView.as_view(), name="sector_team_detail"),
    ...
    url(r"^os_region_groups/$", OverseasRegionGroupListView.as_view(),
        name="overseas_region_groups"),
    url(r"^os_regions/overview/$", OverseasRegionOverviewView.as_view(),
        name="overseas_region_overview"),
    url(r"^os_regions/(?P<region_id>\d+)/$",
        OverseasRegionDetailView.as_view(), name="overseas_region_detail"),
    url(r"^os_regions/(?P<region_id>\d+)/months/$",
        OverseasRegionMonthsView.as_view(), name="overseas_region_monthly"),
    ...
    url(r"^hvc_groups/(?P<group_id>\d+)/$",
        HVCGroupDetailView.as_view(), name="hvc_group_detail"),
    url(r"^hvc_groups/(?P<group_id>\d+)/months/$",
        HVCGroupMonthsView.as_view(), name="hvc_group_months"),
    url(r"^hvc_groups/(?P<group_id>\d+)/campaigns/$",
        HVCGroupCampaignsView.as_view(), name="hvc_group_campaigns"),
    url(r"^hvc_groups/(?P<group_id>\d+)/win_table/$",
        HVCGroupWinTableView.as_view(), name="hvc_group_win_table"),

    url(r"^hvc/(?P<campaign_id>[\w\-]+)/$",
        HVCDetailView.as_view(), name="hvc_campaign_detail"),
    url(r"^hvc/(?P<campaign_id>[\w\-]+)/top_wins/$",
        HVCWinsByMarketSectorView.as_view(), name="hvc_top_wins"),
    url(r"^hvc/(?P<campaign_id>[\w\-]+)/win_table/$",
        HVCWinTableView.as_view(), name="hvc_win_table"),
    ...
    url(r"^countries/(?P<country_code>[\w\-]+)/$",
        CountryDetailView.as_view(), name="country_detail"),
    url(r"^countries/(?P<country_code>[\w\-]+)/months/$",
        CountryMonthsView.as_view(), name="country_monthly"),
    url(r"^countries/(?P<country_code>[\w\-]+)/campaigns/$",
        CountryCampaignsView.as_view(), name="country_campaigns"),
    url(r"^countries/(?P<country_code>[\w\-]+)/top_non_hvcs/$",
        CountryTopNonHvcWinsView.as_view(), name="country_top_nonhvc"),
    url(r"^countries/(?P<country_code>[\w\-]+)/win_table/$",
        CountryWinTableView.as_view(), name="country_win_table"),

    url(r"^posts/$", TeamTypeListView.as_view(team_type='post'), name="post"),
    url(r"^posts/(?P<team_slug>[\w\-]+)/$",
        TeamTypeDetailView.as_view(team_type='post'), name="post_detail"),
    ...
    url(r"^uk_regions/overview/$",
        UKRegionOverview.as_view(team_type='itt'), name="uk_overview"),
